...
:mod:`loman.subscription`  batching and dispatch of change notifications
...
from .subscription import ComputationEvent
...
# loman.subscription and loman.mutation when Computation was split into mixins,
# but they have always been importable from loman.computeengine.
__all__ = [
    "Block",
    "C",
    "CalcNode",
...
class Computation(MutationMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self._pending_changed_nodes = set()
